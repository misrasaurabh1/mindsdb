...
def new_not_implemented_error(request_id):
    # Avoid repeated construction of the error object
    return JSONRPCResponse(id=request_id, error=UNSUPPORTED_OP_ERR)


UNSUPPORTED_OP_ERR = UnsupportedOperationError()
