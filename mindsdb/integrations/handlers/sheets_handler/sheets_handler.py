...
class SheetsHandler(DatabaseHandler):
    ...
    def native_query(self, query: str) -> StatusResponse:
        ...
        Returns:
            HandlerResponse
        """
        # Instead of connecting/disconnecting every time, keep connections alive.
        # Only connect or disconnect if absolutely needed.
    ...
    def query(self, query: ASTNode) -> StatusResponse:
        ...
        Returns:
            HandlerResponse
        """
        # Minor optimization: No local variable assignment needed
    ...
    def _ensure_connection(self):
        """
        Ensure that the connection is established. Only connect if not already connected.
        """
